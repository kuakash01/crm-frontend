...
export default function TaskList({
  ...
  const [data, setData] =
    useState<TasksResponse | null>(null);
  ...
  const [filterEntityType, setFilterEntityType] =
  ...
  const [taskViewOpen, setTaskViewOpen] =
    useState(false);

  /*
   * Is this a module task list?
   */
  const isModuleList =
  ...
  const fetchTasks = async () => {
    try {
      ...
      const result = await getAllTasks({
        ...
        /*
         * If this is a module list,
         * use the supplied entity type.
         *
         * Otherwise use the page filter.
         */
        entityType: isModuleList
          ? entityType
          : filterEntityType === "ALL"
            ? undefined
            : filterEntityType,

        entityId: isModuleList
          ? entityId
          : undefined,
